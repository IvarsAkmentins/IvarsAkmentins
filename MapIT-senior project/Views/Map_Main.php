    ...
    <head>
        ...
        <script>
            $(document).ready(function() {
                ...
                var mapCenter = new google.maps.LatLng(38.4617417,-91.4935753,8z);
                var map;
                    ...
                    if(userstats > 0) {
                        google.maps.event.addListener(map, 'click', function(event) {
                            ...
                            var EditForm = '<p><div class="marker-edit">' +
                                    '<form enctype="multipart/form-data" action="../Controllers/uploadPicture.php" method="POST" name="saveMarker" id="saveMarker" target="iframe">' +
                                    ...
                                    '</tr>' +
                                    '</table>' +
                                    'Picture<input name="image" value="Image" type="file"><br>'+
                            ...
                            if (!data['digs']) {
                                ...
                                for(i = 0; i < data['digs'].length; i++){ 
                                    ...
                                    EditForm = '<p><div class="marker-edit">' +
                                        ...
                                        '<tr>' +
                                        '<td><span>Site Name:</span></td>' +
                                        '<td><input type="text" name="mName" class="dig_name" placeHolder="Enter Dig Site Name" maxlength="50" style="width:228px" value="' + 
data['digs'][i]['name'] + '"/></td>' +
                                        '</tr><tr>' +
                                        '<td><span>Site Description:</span></td>' +
                                   	...
                                   	'Picture<input name="image" type="file"><br>'+
                                    	...
                                    	'<input type="submit" value="Upload" />'+
                                        '</form>' +
                                        '<form action="../Views/uploadedFiles.php" method="post">'+
                                        '<td><input type="text" style="display:none;" name="mName" class="dig_name" placeHolder="Enter Dig Site Name" maxlength="50" style="width:228px" value="' + 
data['digs'][i]['name'] + '"/></td>' +
                                        '<input type="submit" value="See Uploaded Files" />'+
                                        '</form>'+
                                        '<p id="message"></p>'+
                                    	'<p id="message2"></p>'+
                                        '<iframe style="display:none;"   name="iframe"></iframe>'+  
